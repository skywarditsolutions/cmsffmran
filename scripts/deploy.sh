...
echo "    Bob:    bob.amos@ran.demo / Agent#Demo123     (NPN 70000078, MI, French)"
echo "    Kevin:  kevin.mctigue@ran.demo / Agent#Demo123 (NPN 70000079, MI, German)"
echo ""
echo "  Demo routing: submit a request with ZIP 48201 (Michigan)."
echo "    Use French to target Bob, German to target Kevin."
echo ""
